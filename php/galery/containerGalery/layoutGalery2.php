    ...
    if(isset($_GET["tg"])){
      ...
      switch($tipoGaleria){
        case 0:
                  ...
                  <button  class='center'  id='instalations'> Nuestras instalaciones </button>
                  <button  class='centerNOW'  id='photos'> Fotos  </button>
                  <button  class='center'  id='videos'> Videos </button>
                  </div>";
        ...
        case 1: 
                 echo "<div class='menuGalery'>
                 <button  class='centerNOW'  id='instalations'> Nuestras instalaciones </button>
                 <button  class='center'  id='photos'> Fotos  </button>
                 <button  class='center'  id='videos'> Videos </button>
                 </div>";
        ...
        case 2:
                 ...
                 <button  class='center'  id='instalations'> Nuestras instalaciones </button>
                 <button  class='center'  id='photos'> Fotos  </button>
                 <button  class='centerNOW'  id='videos'> Videos </button>
                 </div>";
